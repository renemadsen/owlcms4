...
class ResultsFull extends LitElement {
  ...
  waitingStyles() {
    return (this.mode === "WAIT" || !this.athletes || this.athletes.length === 0) ? "display: grid" : "display: none";
  }

  athleteTableStyles() {
    return (this.mode === "WAIT" || !this.athletes || this.athletes.length === 0) ? "display: none" : "";
  }
